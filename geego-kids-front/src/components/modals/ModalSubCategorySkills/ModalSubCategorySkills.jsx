...
import styles from './ModalSubCategorySkills.module.scss';
import SubCategoryList from '@/components/skills-page/SubCategoryList/SubCategoryList';

const ModalSubCategorySkills = () => {
...
export default ModalSubCategorySkills;
